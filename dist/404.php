			...
			<section class="error-404 not-found page">
				...
				<div class="page-content">
					...
					<div class="widget widget_categories">
						<h2 class="widget-title"><?php esc_html_e( 'Most Used Categories', 'cslpres' ); ?></h2>
						<ul>
							<?php
					...
					$cslpres_archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', 'cslpres' ), convert_smilies( ':)' ) ) . '</p>';
					the_widget( 'WP_Widget_Archives', 'dropdown=1', "after_title=</h2>$cslpres_archive_content" );
